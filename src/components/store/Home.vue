<template>
  <div class="store">
    ...
    <div class="pull-box" ref="wrapper">
      ...
      <div class="pulldown-wrapper" :style="{top: (pos.y - t)/4  + 'px'}">
        <img src="../../assets/image/progress.gif"
             :style="{width: pos.y/2 + 'px',height: pos.y/2 + 'px',opacity: pos.y/100 }"
             alt="">
      </div>
    </div>
  </div>
...
<script>
  ...
  import Time from '../../base/Time.vue'
  ...
  .store
    ...
    .store-middle
      ...
      .store-time
        ...
        .time_show
          float right
          margin px2rem(-24) px2rem(12) 0 0
          display: inline-block
      .store_boom
        width: 100%
        background #fff
